...
const supabaseServiceRoleKey =
  process.env.SUPABASE_SERVICE_ROLE_KEY || "demo-service-key-placeholder";
...
if (process.env.NODE_ENV !== "production" && typeof window !== "undefined") {
  if (
    ...
    console.warn(
      "⚠️ Using placeholder Supabase credentials. Set up your .env.local file for proper configuration."
    );
  }
}
