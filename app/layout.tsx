...
export const metadata = {
  ...
  description:
    "Comprehensive truck management and logistics platform with real-time tracking, automated payments, and intelligent SLA monitoring",
  keywords:
    "logistics, truck management, fleet tracking, payment processing, SLA monitoring, Nigeria",
