...
import { isDemoMode, getDemoConfig, demoConfig } from "@/lib/demo-config";

export default function DemoDashboard() {
  const [activeTab, setActiveTab] = useState("overview");
  const config = getDemoConfig();

  // Use demo configuration data
  const fleetStats = {
    totalTrucks: demoConfig.company.fleet.totalTrucks,
    activeTrucks: demoConfig.company.fleet.activeTrucks,
    inMaintenance: demoConfig.company.fleet.inMaintenance,
    tripsInProgress: 12,
    onTimeDeliveries: demoConfig.company.metrics.onTimeDeliveries,
    totalRevenue: demoConfig.company.metrics.totalRevenue,
    monthlyGrowth: demoConfig.company.metrics.monthlyGrowth,
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600">
              {demoConfig.company.description}
            </p>
          </div>
      ...
      <div className="p-6">
        <ErrorBoundary>
          <ConnectionStatusHandler demoMode={isDemoMode()}>
            <Tabs
              value={activeTab}
              ...
              <TabsContent value="overview" className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">
                        {fleetStats.activeTrucks} active,{" "}
                        {fleetStats.inMaintenance} in maintenance
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">
                        ₦{fleetStats.totalRevenue.toLocaleString()}
                      </div>
                      <p className="text-xs text-muted-foreground">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Upcoming maintenance and service requirements
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-4">
              ...
              <TabsContent value="payments" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Current payment status and recent transactions
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
