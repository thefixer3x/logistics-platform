...
interface ConnectionStatusHandlerProps {
  ...
  demoMode?: boolean; // if true, show connection warnings but don't block content
}
    ...
    return (
      <Card className="w-full max-w-md mx-auto mt-8">
        ...
        <CardContent>
          ...
          <RetryButton onRetry={isChecking ? undefined : checkConnection} />
        </CardContent>
      </Card>
    );
  }
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-md p-3 mb-4">
          <div className="flex items-center">
            ...
            <p className="text-sm text-yellow-800">
              Demo Mode: Database connection unavailable. Showing mock data.
            </p>
          </div>
        </div>
      )}
